...
final class QuadrilateralView: UIView {
    ...
    internal(set) var quad: Quadrilateral?
...
//            quadLayer.fillColor = editable ? UIColor(white: 0.0, alpha: 0.6).cgColor : UIColor(white: 1.0, alpha: 0.5).cgColor
            ...
            quadLayer.fillColor = editable ? UIColor(white: 0.0, alpha: 0.6).cgColor : UIColor.init(hex: 0x007AFF, alpha: 0.25).cgColor
    ...
    let highlightedCornerViewSize = CGSize(width: 120.0, height: 120.0)
...
//        quadLayer.isHidden = false
    ...
    func resetHighlightedCornerViews() {
        isHighlighted = false
        resetHighlightedCornerViews(cornerViews: [topLeftCornerView])
    }
