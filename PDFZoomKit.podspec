#
#  Be sure to run `pod spec lint PDFZoomKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/vunk93"
  ...
  spec.source       = { :git => "https://github.com/AperoVN/PDFZoomKit.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "PDFZoomKit", "PDFZoomKit/**/*.{h,swift,modulemap}"
  spec.exclude_files = "PDFZoomKit/Exclude"
